...
int main(int argc, char *argv[]){
    ...
    for (int i = 0; i < N; i++) {                                                   // Loop over the blocks
        ...
        for (int j = 0; j < L; j++){                                                // Loop ovewr the throws       

            MetropolisUniform(x, TWF, rnd, c, accepted, attempted);                 // Updates my position according to my trial wave function distribution
